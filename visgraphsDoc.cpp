...
void CvisgraphsDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CvisgraphsDoc::InitializeSearchContent()
{
...
void CvisgraphsDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
...
// Диагностика CvisgraphsDoc

#ifdef _DEBUG
void CvisgraphsDoc::AssertValid() const
{
	CDocument::AssertValid();
}

void CvisgraphsDoc::Dump(CDumpContext& dc) const
{
	CDocument::Dump(dc);
}
#endif //_DEBUG
